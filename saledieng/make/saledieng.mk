...
CPP_TEST += saledieng/catch/catchmain.cpp
...
STDVERSION = -std=c++14 
STDLIBVERSION_CLANG = -stdlib=libc++ 
...
$(OBJS_DIR):
	@mkdir -p $(OBJS_DIR)
	@mkdir -p $(OBJS_DIR)/saledieng
	@mkdir -p $(OBJS_DIR)/saledieng/catch
...
-include $(OBJS_DIR)/*.d
-include $(OBJS_DIR)/saledieng/*.d
-include $(OBJS_DIR)/saledieng/catch/*.d
